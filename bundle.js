      ...
      var headers = this.props.panes.map(function (pane, index) {
        ...
        return _react2.default.createElement(
          'li',
          {
            key: index,
            className: status,
            onClick: _this2.props.onSelectedTab.bind(null, index) },
          title,
          ' '
        );
      });
...
var Weather = function (_React$Component) {
  ...
  function Weather() {
    ...
    _this.locWeather = _this.locWeather.bind(_this);
    return _this;
  }
  ...
  _createClass(Weather, [{
    ...
    key: 'locWeather',
    value: function locWeather(position) {
      var _this2 = this;
      ...
      request.onreadystatechange = function () {
        if (request.readyState === XMLHttpRequest.DONE && request.status === 200) {
          var kel = JSON.parse(request.response).main.temp;
          var farh = Math.round((kel - 273.15) * 1.8 + 32);
          _this2.setState({ temp: farh });
        }
      };
      request.send();
    }
